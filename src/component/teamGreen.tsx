...
const teamGreen = (props: dataTableInfoProps) => {
    return (
        <div className="organisation-konto-frame-365x">
            <div className="organisation-konto-team-green">
                <div className="organisation-konto-frame-362x-3">
                    <DragIndicator />
                    <p className="organisation-konto-team-bl">Team Grön</p>
                    <ArrowDropDown />
                </div>
                <p className="organisation-konto-dlj-3">Dölj</p>
            </div>
            {props.dataTableGreenInfo.map(item => {
                return (
