...
const teamGul = (props: dataTableInfoProps) => {
    return (
        <div className="organisation-konto-frame-365x">
            <div className="organisation-konto-team-gul">
                <div className="organisation-konto-frame-362x-3">
                    <DragIndicator />
                    <p className="organisation-konto-team-bl">Team Gul</p>
                    <ArrowDropDown />
                </div>
